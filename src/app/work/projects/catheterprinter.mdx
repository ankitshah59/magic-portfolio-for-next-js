...
images:
  ...
  - "/images/projects/project-01/Smart9.png"
...
The rotary catheter printer is a **closed-loop, height-compensated direct-ink-writing (DIW) system** developed to print smart electronics directly onto soft, flexible catheter bodies. Unlike planar printing or film-wrapping techniques, this system performs **true conformal printing** on cylindrical surfaces, enabling 360° coverage with sub-100 μm resolution.

At its core, the system synchronizes a **motorized rotational stage**, orthogonal **X and Z linear axes**, and a **high-speed confocal displacement sensor** to maintain a stable nozzle-to-surface distance during printing—essential for clean, high-resolution features on deformable substrates.
...
💡 **Breakthrough**: One of the **first fully-integrated, PID-controlled DIW systems** built specifically for medical-grade catheter manufacturing.

---

## Hardware Architecture

### 1. Rotary θ-Stage (PRM1Z8)
...
The **Nordson Ultimus V** regulates ink flow (0–800 kPa) and ensures smooth, stable deposition for functional inks with viscosities up to 5000 cP.
...
- Maintains **50 μm standoff** with **±5 μm error**
...
**Feature dimensions:**
- Line width: **approximately 50 μm** (PEDOT:PSS/CNT)
- Metallic traces: **60–120 μm** (Ag-TPU / Ag-NP)
- Layer thickness: **20–40 μm**
- Angular precision: **0.007°**
- Linear accuracy: **1 μm** (LTS150 specification)

**Print quality:**
- Uniform trace width across 360° rotation
...
**LIMR — Lathe-based Intelligent Micro-dispensing and Registration**

A custom C# WinForms control application integrating:

- **Thorlabs Kinesis SDK**: X, Z, θ motion control
...
Precision jigs ensured proper alignment of X, Z, and θ axes, with custom fixtures to minimize eccentricity.

**Design considerations:**
- Orthogonal axis alignment (less than 0.1° deviation)
- Vibration isolation platform
- Thermal stability (temperature-controlled environment)
- Rigid frame construction (aluminum extrusion)

### 2. Sensor–Nozzle Offset Calibration
...
Ag-TPU, Ag-NP, PEDOT:PSS, and CNT formulations were optimized (150–5000 cP) with plasma surface prep improving adhesion.

**Optimization parameters:**
- Viscosity matching to pressure
- Shear-thinning behavior
- Nozzle diameter selection (100-400 μm)
...
- Overshoot: **less than 2 μm**
- Stable tracking: **±5 μm** variation
...
**Performance:**
- Drift: **less than 10%** across 20–50 cycles
...
**Performance:**
- Temperature: **approximately 55°C at 7 V**
...
**Precision metrics:**
- Z-axis tracking error: ±5 μm
- Line width variation: less than 10%
- Layer registration: less than 20 μm
- Angular positioning: 0.007° accuracy
...
- Precise closed-loop adaptive control with sub-10 μm accuracy
...
This work establishes the foundation for next-generation smart catheters with **integrated sensing, actuation, and identification capabilities**—all printed directly onto their surfaces with micron-scale precision.
